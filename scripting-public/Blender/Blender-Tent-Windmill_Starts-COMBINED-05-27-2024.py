...
# Create  five tents
tent1 = create_tent('Tent1', (-45, 0, 0), size=1, inset_thickness=0.2, inset_depth=0.2)
tent2 = create_tent('Tent2', bpy.context.scene.cursor.location + Vector((-40, -12, 0)))
tent3 = create_tent('Tent3', bpy.context.scene.cursor.location + Vector((-35, -12, 0)))
tent4 = create_tent('Tent4', bpy.context.scene.cursor.location + Vector((-30, -12, 0)))
tent5 = create_tent('Tent5', bpy.context.scene.cursor.location + Vector((-25, -12, 0)))
